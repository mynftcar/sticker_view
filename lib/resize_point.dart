...
class ResizePoint extends StatelessWidget {
  const ResizePoint({Key? key, required this.onDrag, required this.type, this.onScale, this.iconData}) : super(key: key);
  ...
  MouseCursor get _cursor {
    return Constants.cursorLookup[type]!;
  }
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: DraggablePoint(
        ...
        onScale: onScale,
        child: Container(
          width: Constants.cornerDiameter,
          height: Constants.cornerDiameter,
